	...
	:QDialog(parent) 
{
	...
	modeLayout->addWidget(comboBox);


	QVBoxLayout *firstupLayout = new QVBoxLayout();
	firstLayout->addLayout(firstupLayout);

	firstupLayout->addLayout(modeLayout);


	rbFrame = new QFrame();

	QRadioButton *rb1 = new QRadioButton("Perfect electric conductor");
	QRadioButton *rb2 = new QRadioButton("Perfect magnetic conductor");
	QRadioButton *rb3 = new QRadioButton("Free space");

	QVBoxLayout *rbLayout = new QVBoxLayout();
	rbFrame->setLayout(rbLayout);
	...
	firstupLayout->addWidget(rbFrame);
