...
QT_MOC_LITERAL(3, 24, 7) // "on_exec"

    },
    "Atmosphere_Dlg\0onclose\0\0on_exec"
};
#undef QT_MOC_LITERAL
...
struct qt_meta_stringdata_Import_Heat_Source_Dlg_t {
    QByteArrayData data[4];
    char stringdata0[38];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Import_Heat_Source_Dlg_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Import_Heat_Source_Dlg_t qt_meta_stringdata_Import_Heat_Source_Dlg = {
    {
QT_MOC_LITERAL(0, 0, 22), // "Import_Heat_Source_Dlg"
QT_MOC_LITERAL(1, 23, 7), // "onclose"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 5) // "on_Ok"

    },
    "Import_Heat_Source_Dlg\0onclose\0\0on_Ok"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_Import_Heat_Source_Dlg[] = {
...
const QMetaObject Import_Heat_Source_Dlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Import_Heat_Source_Dlg.data,
      qt_meta_data_Import_Heat_Source_Dlg,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_Import_Heat_Source_Dlg.stringdata0))
