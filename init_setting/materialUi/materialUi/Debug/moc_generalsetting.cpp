...
const QMetaObject GeneralSetting::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_GeneralSetting.data,
      qt_meta_data_GeneralSetting,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GeneralSetting::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GeneralSetting.stringdata0))
        return static_cast<void*>(const_cast< GeneralSetting*>(this));
